                ...
                while(b<2) {
                    if (data0[x].events[i].start == times[a]) {
                        ...
                        if(data0[x].events[i].facilities[0] != null) {
                            roosterClasses[0].innerHTML += "<div onclick='clickClass("+x+","+i+")' style='height: " + positionHeight[e] + "px; top: " + positionTop[a] + "px; left: " + positionLeft[x] + "px'>" + data0[x].events[i].description + "<br/>" + "<i>" + data0[x].events[i].facilities[0] + " - " + data0[x].events[i].staffs[0] + "</i>" + "</div>";
                        } else {
                            roosterClasses[0].innerHTML += "<div onclick='clickClass("+x+","+i+")' style='height: " + positionHeight[e] + "px; top: " + positionTop[a] + "px; left: " + positionLeft[x] + "px'>" + data0[x].events[i].description + "<br/>" + "<i>" + data0[x].events[i].staffs[0] + "</i>" + "</div>";
                        }
                    } else {
                        a++;
                    }
