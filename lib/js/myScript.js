                ...
                while(b<2) {
                    if (data0[x].events[i].start == times[a]) {
                        ...
                        if(data0[x].events[i].facilities[0] != null && data0[x].events[i].facilities[0] != null) {
                            ...
                            roosterClasses[0].innerHTML += "<div data-day='"+x+"' data-start='"+data0[x].events[i].start+"' class='classblock' value='"+classID+"' onclick='clickClass("+x+","+i+")' style='height: " + positionHeight[e] + "px; top: " + positionTop[a] + "px; left: " + positionLeft[x] + "px'>" + data0[x].events[i].description + "<br/>" + "<i>" + data0[x].events[i].staffs[0] + "</i>" + "<div class='aanwezigheidTab'></div></div>";
                        } else if(data0[x].events[i].staffs[0] == null && data0[x].events[i].facilities[0] != null) {
...
var ws = new WebSocket("ws://remi.im:13376/ws");
